...
import { DropDownComponent} from './directives/componentdirective/formdirective/app.form.dropdown.component.directive';
...
@NgModule({
  declarations: [
    AppComponent,
    ProductComponent, DataTableComponent,DropDownComponent,
